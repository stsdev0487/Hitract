...
import { Text, Header, Right, Left, Container, Button, Thumbnail, Icon, Body, Title } from 'native-base'
...
export default class SingleUserChat extends React.Component {
        ...
        return (
            <Container style={{ backgroundColor: '#E6ECF0' }}>
                ...
                >
                    ...
                    <Body>
                        <Title style={{ color: 'black' }}>Martha McDoo</Title>
                    </Body>
                </Header>
                <Messages />
            </Container>
